...
| `public/play/` | The game itself — **unmodified** original release (the server injects the site navigation bar into the served page at request time; the files on disk are untouched) |
